<ul class="share-links columns">
	...
	<li><a href="https://www.linkedin.com/shareArticle?mini=true&url=<?php echo wp_get_shortlink(); ?>&title=<?php the_title(); ?>&summary=<?php echo wp_filter_nohtml_kses( $content );?>&source=<?php echo site_url(); ?>" title="Share on Linkedin" target="_blank"><i class="fi-social-linkedin"></i></a></li>
